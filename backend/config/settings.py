...
SECRET_KEY = "django-insecure-!@$d&9#ahl)+%-xes$a8m4*!xr^7cc=du4ut%7cmn%g1l@!y%8"
...
DATABASES = {
    "default": {
        ...
        "NAME": BASE_DIR.parent / "database" / "elarion.sqlite3",
    }
}
...
# Security defaults for auth/session handling.
